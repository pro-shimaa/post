...
include"e/menu.php";//define total number of results you want per page  
    ...
    $query = "select *from temp where status=8";  
    ...
    $query = "SELECT *FROM temp where status=8  LIMIT " . $page_first_result . ',' . $results_per_page;  
    $result = mysqli_query($post, $query);  
...
<tr align="center">
      ...
      <td><a href="../log/<?php echo $row['upload_path']; ?>" download>Download</td></td>
            <td><a href="../log/<?php echo $row['upload_update_path']; ?>" download>Download</td></td>
